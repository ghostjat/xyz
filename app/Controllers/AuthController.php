...
class AuthController extends BaseController
{
    ...
    public function processLogin()
    {
        ...
        // Set session data (using CodeIgniter's built-in session - no custom table needed)
        $this->session->set([
            'user_id' => (int)$user['id'],
    ...
    public function processRegister()
    {
        ...
        // Log activity - only log non-sensitive data
        $this->logActivity('register', 'users', $userId, [
