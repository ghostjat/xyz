...
class AssessmentController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('assessment/dashboard', $data);
    }
    ...
    public function completeTest()
    {
        ...
        // Check if all tests in session are complete
        $this->checkSessionCompletion($session['id']);
    ...
    private function checkSessionCompletion($sessionId)
    {
        ...
        if ($allComplete) {
            ...
            $this->generateComprehensiveReport($sessionId);
        }
    }
    ...
    {
        return $this->db->table('test_categories')
